...
class Vector
{
  public:
    ...
    const T& max( const unsigned long int& start, const unsigned long int& end ) const;
    const T& min( const unsigned long int& start, const unsigned long int& end ) const;
    unsigned long int max_index( const unsigned long int& start, const unsigned long int& end ) const;
    unsigned long int min_index( const unsigned long int& start, const unsigned long int& end ) const;
