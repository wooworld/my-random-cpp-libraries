...
/*******************************************************************************
  ...
  @desc A simple parallel processing implementation of the prime number seive
        to find all prime numbers between 0 and a supplied number N.
  @auth Gary Steelman
  @date 4 Feb 2011
*******************************************************************************/
...
void driver( int argc, char* argv[] )
{
  ...
  {    
    // 0-------x3------------|x1------------x2|-----------
    // x3 - (x1 % x3) = number of indices positive displacement from x1 to find
                     // the first multiple of x3 in the interval [x1,x2]
    // x3 - (x1 % x3) + x1 = the real value of the first multiple of x3 in [x1,x2]
