...
string str_strip(string str, string to_strip, bool leading = true,
                 bool inner = true, bool trailing = true);
// Overloaded to accept a character
string str_strip(string str, char to_strip, bool leading = true,
                 bool inner = true, bool trailing = true);

string str_replace_all(string str, string to_replace, string replace_with,
                       char ignore_following = '\\');
...
string str_find_range(string str, char start, string end, bool nested = false,
                      bool inclusive = true, bool ignore_quotes = false,
                      char ignore_following = '\\');
...
vector<string> str_find_lines(string str,
                              string delimiters = char_to_str('\n'),
