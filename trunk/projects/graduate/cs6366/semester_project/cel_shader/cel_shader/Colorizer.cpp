...
Colorizer::Colorizer( const col3& colors ) { 
  init();
  setColor( colors ); 
}

Colorizer::Colorizer( const col4& colors ) { 
  init();
  setColor( colors ); 
}
...
GLvoid Colorizer::setColor( const col3& c ) {
  setColor( c[0], c[1], c[2], 1.0 );
}

GLvoid Colorizer::setColor( const col4& c ) {
