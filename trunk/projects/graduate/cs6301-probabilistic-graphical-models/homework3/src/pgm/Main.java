  ...
  public static void main(String[] args) {
      ...
      /*if (gm.type == GraphModelType.BAYES) {
        ...
        System.out.println("Partition function log10: " + gm.computeParitionFunctionGivenEvidence());
		  ...
		  /*VariableCollectionType variables = new VariableList();
		  variables.add(new Variable(2));
		  variables.add(new Variable(3,4));
		  System.out.println(variables);
		  
		  System.out.println(variables.get(0));
		  System.out.println(variables.get(1));
		  
		  variables.set(0, new Variable(3));
		  System.out.println(variables);
		  ...
		  /*EvidenceCollectionType evidence = new EvidenceHashMap();
		  evidence.add(0, 1);
		  evidence.add(new Variable(1, 2), 0);
		  System.out.println(evidence);
		  
		  System.out.println(evidence.get(0));
		  System.out.println(evidence.get(new Variable(1, 2)));
		  
		  evidence.set(0, 0);
		  System.out.println(evidence);
		  
		  evidence.remove(new Variable(0, 1));
		  System.out.println(evidence);
		  
		  System.out.println(evidence.contains(1));*/
