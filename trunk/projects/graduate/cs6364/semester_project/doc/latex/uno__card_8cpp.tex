...
\-The map is arranged such that card names can be accessed using the \-C\-A\-R\-D macro function. \begin{DoxyNote}{\-Note}
...
\-The map is arranged such that card weights can be accessed using the \-C\-A\-R\-D macro function. \begin{DoxyNote}{\-Note}
