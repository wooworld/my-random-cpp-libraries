...
//////////////////////////////////////////////////////////////////////
/// @fn vector<string> str_find_lines(string str, string delimiters, bool keep_delim)
/// @brief -- Forwards to str_split.
//////////////////////////////////////////////////////////////////////
...
string str_strip(string str, string to_strip, bool leading = true, bool inner = true, bool trailing = true);
// Overloaded to accept a character
string str_strip(string str, char to_strip, bool leading = true, bool inner = true, bool trailing = true);
...
string num_to_str(int num, unsigned int precision = 1);
string num_to_str(unsigned int num, unsigned int precision = 1);
string num_to_str(double num, unsigned int precision = -1);

// Deprecated. Forwarded to their respective num_to_str versions.
...
vector<string> str_split(string str, string delimiters = char_to_str('\n'), bool keep_delim = false);

// Deprecated. Forwards to str_split.
