...
/// @note Works decently with smaller files. Don't use large files. 
///////////////////////////////////////////////////////////////////////////////
...
void File::print()
{
  for ( unsigned long int i = 0; i < get_num_lines(); i++ )
...
void File::remove_blank_lines()
{
  unsigned long int i = 0;
  while ( i < get_num_lines() )
  {
    if ( get_line( i ) == ""  || get_line( i ) == char_to_str('\n') )
      remove_line( i );
    else
      i++;
  }
  
  /*for ( unsigned int i = 0; i < get_num_lines(); i++ )
  {
    if ( get_line( i ) == "" )
      remove_line( i );
  }*/
