...
GLvoid Keyboard::init() {
  m_keys = new GLboolean[NUM_KEYS];
  m_specialKeys = new GLboolean[NUM_KEYS];
  memset( m_keys, GL_FALSE, sizeof(GLboolean)*NUM_KEYS );
  memset( m_specialKeys, GL_FALSE, sizeof(GLboolean)*NUM_KEYS );
}
