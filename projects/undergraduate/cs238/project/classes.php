            ...
            <table class="style26">
                ...
                <tr>
                    ...
                    <td class="style27">
                        ...
                        <a href="index.html">Home</a> &gt; <a href="classes.php">Classes</a><br />
...
$query_results = my_trusted_mysql_query( "SELECT EVENT.Event_ID, Event_Name, Start_Date, Start_Time, End_Date, End_Time, Location_Name, Address, City, State, Zip FROM EVENT JOIN LOCATION ON (EVENT.EVENT_ID = LOCATION.EVENT_ID) WHERE EVENT.E_Type = 'c'" );
...
foreach ($query_results as $row) 
{
  ...
  foreach( $row as $key => $value )
  {
    if($key == "Event_ID")
    {
      echo "<td><a href='http://group13.x10hosting.com/class_part_manip.php'>$value</a></td>";
    }
    else
    {     
      echo "<td>$value</td>";
