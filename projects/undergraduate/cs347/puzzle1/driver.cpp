...
/// @edit 23 Jan 2010
/// @brief A driver for the traveling salesman problem. Solves via random node
///   choice. 
/// @note Assignment 1.
...
//Headers for File and exception handling
#include "exception.h"
#include "str_manip.h"
#include "matrix.h"
#include "TSP-Rand.h"
...
void driver( int argc, char* argv[] )
{
  ...
  cout << "Traveling Salesman Problem\n--Random Selection Algorithm" << endl;
  ...
  cout << "\nTotal distance traversed: " << endl;
  cout << TSP.distanceTraveled() << endl;
  
  cout << "\nRun complete! Exiting program..." << endl;
